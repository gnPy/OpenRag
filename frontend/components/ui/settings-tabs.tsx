  ...
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-lg p-[3px] text-muted-foreground group-data-[orientation=horizontal]/tabs:h-8 group-data-[orientation=vertical]/tabs:h-fit group-data-[orientation=vertical]/tabs:flex-col data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        ...
        ibm: "mb-6 h-auto gap-0 rounded-none bg-transparent p-0 group-data-[orientation=horizontal]/tabs:h-auto",
      },
    },
    defaultVariants: {
      variant: "default",
...
const tabsTriggerVariants = cva("", {
  variants: {
    variant: {
      ...
      ibm: cn(
        "ibm-tab-underline ibm-body-compact inline-flex flex-none h-auto items-center px-4 py-[11px] shadow-none transition-none hover:bg-accent",
